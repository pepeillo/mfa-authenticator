...
public class FileUtils {
    ...
    public static String getFolderPath(Context context, Uri sourceUri) {
        Uri uri = DocumentsContract.buildDocumentUriUsingTree(sourceUri, DocumentsContract.getTreeDocumentId(sourceUri));
